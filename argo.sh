...
# == Config the ARGOCD_HOSTNAME and ADMIN_EMAIL variables before running.
# == It assumes you have Traefik as the Ingress controller.
# == Make sure to have Helm and kubectl installed and configured.
# == This script is designed to be run in a K3s cluster environment.
# ===================================================================

# --- Configuration ---
ARGOCD_HOSTNAME="argocd.example.com"
ADMIN_EMAIL="admin@example.com" # <<< IMPORTANT: CHANGE THIS TO YOUR EMAIL
